  ...
  return (
    <>
      <ContactInfoSmallScreen>
        <a href="mailto:hello@southporthandyman.co.uk">📧 hello@southporthandyman.co.uk</a>
      ...
      <Wrapper className="flexCenter animate whiteBg" style={y > 100 ? { height: "60px" } : { height: "100px" }}>
        ...
        setTimeout(() => {
          ...
          <UlWrapperRight className="flexNullCenter">
            <li className="semiBold font15 pointer">
              <a href="mailto:hello@southporthandyman.co.uk" style={{ padding: "10px 30px 10px 0" }}>📧 hello@southporthandyman.co.uk</a> <br/>
